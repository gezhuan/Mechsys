...
public:
    // Constructor and destructor
    SphereCollision (Particle * Pt1, Particle * Pt2);        ///< Default constructor
    ~SphereCollision () {}          ///< Destructor
...
inline SphereCollision::SphereCollision(Particle * Pt1, Particle * Pt2)
{
    P1   = Pt1;
    P2   = Pt2;
    I1 = P1->Index;
...
inline bool SphereCollision::CalcForce(double dt)
{
    Nc     = 0;
    Nsc    = 0;
    Nr     = 0;
...
inline void SphereCollision::UpdateParameters ()
{
    Kn   = 2*ReducedValue(P1->Props.Kn,P2->Props.Kn);
    Kt   = 2*ReducedValue(P1->Props.Kt,P2->Props.Kt);
    Gn   = 2*ReducedValue(P1->Props.Gn,P2->Props.Gn)*ReducedValue(P1->Props.m,P2->Props.m);
