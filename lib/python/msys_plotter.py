...
from numpy   import sqrt, matrix, zeros, log, cos, pi, sin
from pylab   import rc, subplot, plot, xlabel, ylabel, grid, axhline, axvline, axis, text
from msys_invariants import sig_calc_p_q, sig_calc_t, sig_calc_s123, s123_calc_oct, eps_calc_ev_ed, eps_calc_e123
