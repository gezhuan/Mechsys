...
int main(int argc, char **argv) try
{
	...
	if (is_o2)
	{
		...
		eatts.Push (make_tuple(-2, "Quad8PStrain", "LinElastic", prms.CStr(), "ZERO", "gam=20", true));
		eatts.Push (make_tuple(-3, "Quad8PStrain", "LinElastic", prms.CStr(), "ZERO", "gam=20", true));
	}
	else
	{
		eatts.Push (make_tuple(-1, "Quad4PStrain", "LinElastic", prms.CStr(), "ZERO", "gam=20", true ));
		eatts.Push (make_tuple(-2, "Quad4PStrain", "LinElastic", prms.CStr(), "ZERO", "gam=20", true));
		eatts.Push (make_tuple(-3, "Quad4PStrain", "LinElastic", prms.CStr(), "ZERO", "gam=20", true));
	}
	...
	Output out;  out.OpenCollection ("texcav01");
