...
FIND_LIBRARY(LAPACK_BLAS     NAMES blas    PATHS ${LAPACK_LIBRARY_SEARCH_PATH})
FIND_LIBRARY(LAPACK_LAPACK   NAMES lapack   PATHS ${LAPACK_LIBRARY_SEARCH_PATH})

SET(LAPACK_FOUND 1)
FOREACH(var LAPACK_BLAS LAPACK_LAPACK)
  IF(NOT ${var})
	SET(LAPACK_FOUND 0)
  ENDIF(NOT ${var})
ENDFOREACH(var)
...
IF(LAPACK_FOUND)
  SET(LAPACK_LIBRARIES ${LAPACK_LAPACK} ${LAPACK_BLAS})
ENDIF(LAPACK_FOUND)
