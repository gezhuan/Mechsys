...
FIND_PATH(UMFPACK_UFCONFIG_H UFconfig.h ${UMFPACK_INCLUDE_SEARCH_PATH})
...
SET(UMFPACK_FOUND 1)
FOREACH(var UMFPACK_UFCONFIG_H UMFPACK_UMFPACK_H UMFPACK_AMD_H UMFPACK_UMFPACK UMFPACK_AMD)
  IF(NOT ${var})
	SET(UMFPACK_FOUND 0)
  ENDIF(NOT ${var})
ENDFOREACH(var)
...
IF(UMFPACK_FOUND)
  SET(UMFPACK_INCLUDE_DIRS ${UMFPACK_AMD_H} ${UMFPACK_UFCONFIG_H} ${UMFPACK_UMFPACK_H})
