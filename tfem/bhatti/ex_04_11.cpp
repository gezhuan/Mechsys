...
int main(int argc, char **argv) try
{
    ...
    //mesh.WriteMPY ("ex411_mesh");

    ////////////////////////////////////////////////////////////////////////////////////////// FEM /////

    // elements properties
    Dict prps;
    prps.Set(-1, "prob  E A Izz  fra", PROB("Beam"),  3.0e+4, 100.0, 1000.0,  1.0);
    prps.Set(-2, "prob  E A Izz  fra", PROB("Beam"),  3.0e+4, 100.0, 1000.0,  1.0);
    ...
    //dom.WriteMPY ("ex411", 0.001);

    //////////////////////////////////////////////////////////////////////////////////////// Check /////

    // correct solution
    Table nod_sol;
    nod_sol.Set("                   ux                      uy                      wz          M", /*NRows*/dom.Nods.Size(),
                 0.000000000000000e+00,  0.000000000000000e+00,  0.000000000000000e+00,  -288.462,
                 6.016073731432885e-04, -1.254737159610633e-03,  1.685087639678406e-04,  -105.368,
                 0.000000000000000e+00,  0.000000000000000e+00,  0.000000000000000e+00,    49.199);

    Table ele_sol;
    ele_sol.Set("                    N                       V", /*NRows*/dom.Eles.Size(),
                -7.697208350099685e+00,  1.017186578051514e+00,
                -1.002678955238814e+01,  8.587068887342608e-01);

    // error tolerance
    SDPair nod_tol, ele_tol;
    nod_tol.Set("ux uy wz M", 1.0e-15,1.0e-15,1.0e-15,1.0e-3);
    ele_tol.Set("N  V",  1.0e-14,1.0e-14);
