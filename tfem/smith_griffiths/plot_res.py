...
if True:
    ...
    p113d = read_table("sm_11_07_p113.dat")
    p113  = read_table("sm_11_07_p113.res")
    p114  = read_table("sm_11_07_p114.res")
    ...
    legend(['MechSys','SM:p113d','SM:p113','SM:p114'],loc='upper left')
    grid()
    show()
