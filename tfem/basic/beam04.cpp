...
int main(int argc, char **argv) try
{
	...
	mesh.SetVert    (1, true,   a, 0.0);
	mesh.SetVert    (2, true, a+b, 0.0);
	...
	dat.Nod(2)->Bry("ux", 0.0)->Bry("uy", 0.0)->Bry("wz", 0.0);
	...
	// Elements
	std::ofstream of("beam04_elems.cal", std::ios::out);
	...
	cout << "\nFile <[1;31mbeam04_elems.cal[0m> created" << endl;
	of.close();

	// Elements
	std::ofstream pf("beam04_nodes.cal", std::ios::out);
	...
	cout << "File <[1;31mbeam04_nodes.cal[0m> created" << endl;
	pf.close();
