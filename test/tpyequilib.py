...
blocks[0].set    (-1,                                   # tag to be replicated to all elements
                  [(0,0,0), (1,L,0), (2,L,H), (3,0,H)], # vertices' coordinates
...
# Data and Solver
dat = ms.data   (2)
sol = ms.solver (dat, "tpyequilib_py")

# Elements attributes
eatts = [[-1, 'Quad4', 'PStrain', 'PyEquilib,mymodel.py', 'a0=%f a1=%f'%(E,nu), 'ZERO', 'gam=%f'%(gam), True]]
